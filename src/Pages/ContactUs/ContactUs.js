...
const ContactUs = () => {
  return (
    <div>
      <Navigation />
      <div className="py-4 bg-white text-white">
        <div className="container mx-auto flex flex-col md:flex-row my-12 md:my-36">
          <div className="flex flex-col w-full lg:w-2/5 p-8">
            <p className="text-3xl md:text-5xl text-pink-700 my-4 leading-relaxed md:leading-snug">
              Contact our team
            </p>
            <p className="font-sans text-sm text-black md:text-lg my-2 md:my-4">
              <svg
            ...
            <p className="font-sans text-black text-sm md:text-lg my-2 md:my-4">
              <svg
                className="inline-block fill-current mr-2"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
