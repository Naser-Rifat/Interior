      ...
      <div className="pt-6 pb-40">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1532372320572-cda25653a26d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80')",
            }}
          ></div>
          <div className="w-full p-8 lg:w-1/2">
            ...
            <form onSubmit={handleOnsubmit}>
              ...
              {error && <div>{error}</div>}
              {openmodal && (
                <ModalverifyEmail closeModal={setOpenModal}></ModalverifyEmail>
              )}
              <div className="mt-8">
                <button
                  type="submit"
