			  ...
			  <div className="w-full p-8 lg:w-1/2">
				...
				<form onSubmit={handleOnsubmit}>
				  ...
				  <div className="mt-4">
					  ...
					  <input onChange={handleOnchange} name='username' className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text"/>
				  </div>
				  <div className="mt-4">
