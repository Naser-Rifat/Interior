                        ...
                        <div className="p-4  lg:w-1/3 ">
                            <div className="flex rounded-lg h-full bg-white border shadow- p-8 flex-col">
                                ...
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base text-justify text-gray-500 ">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                                    <a href="" className="mt-3 text-indigo-800 hover:text-gray-900 inline-flex items-center">Learn More
